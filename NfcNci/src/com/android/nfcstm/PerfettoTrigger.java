...
/** Copied over from frameworks/base/core/java/com/android/internal/util/PerfettoTrigger.java */
public class PerfettoTrigger {
    ...
    /**
     * @param triggerName The name of the trigger. Must match the value defined in the AOT Perfetto
     *     config.
     */
