...
public class DeviceConfigFacade {
    ...
    private void updateDeviceConfigFlags() {
        ...
        mSecureNfcCapable =
                DeviceConfig.getBoolean(
                        DeviceConfig.NAMESPACE_NFC,
                        KEY_SECURE_NFC_CAPABLE,
                        isSecureNfcCapableDefault());
        ...
        mEnableServiceOther =
                DeviceConfig.getBoolean(
                        ...
                        mContext.getResources()
                                .getBoolean(R.bool.enable_service_for_category_other));

        mTagIntentAppPrefSupported =
                DeviceConfig.getBoolean(
                        DeviceConfig.NAMESPACE_NFC,
                        "tag_intent_app_pref_supported",
                        mContext.getResources().getBoolean(R.bool.tag_intent_app_pref_supported));

        mProprietaryGetcapsSupported =
                DeviceConfig.getBoolean(
                        DeviceConfig.NAMESPACE_NFC,
                        "nfc_proprietary_getcaps_supported",
                        mContext.getResources()
                                .getBoolean(R.bool.nfc_proprietary_getcaps_supported));
        ...
        mEnableDeveloperNotification =
                DeviceConfig.getBoolean(
                        DeviceConfig.NAMESPACE_NFC,
                        "enable_developer_option_notification",
                        mContext.getResources()
                                .getBoolean(R.bool.enable_developer_option_notification));
        ...
        mCheckDisplayStateForScreenState =
                DeviceConfig.getBoolean(
                        ...
                        mContext.getResources()
                                .getBoolean(R.bool.check_display_state_for_screen_state));

        mIndicateUserActivityForHce =
                DeviceConfig.getBoolean(
                        DeviceConfig.NAMESPACE_NFC,
    ...
    public boolean getPollingDisableAllowed() {
        return mPollingDisableAllowed;
    }

    public boolean getNfccAlwaysOnAllowed() {
        return mNfccAlwaysOnAllowed;
    }

    public boolean getEnableServiceOther() {
        return mEnableServiceOther;
    }

    public boolean getTagIntentAppPrefSupported() {
        return mTagIntentAppPrefSupported;
    }

    public boolean getProprietaryGetcapsSupported() {
        return mProprietaryGetcapsSupported;
    }

    public boolean getEnableOemExtension() {
        return mEnableOemExtension;
    }

    public boolean getEnableDeveloperNotification() {
        return mEnableDeveloperNotification;
    }

    public boolean getCheckDisplayStateForScreenState() {
        return mCheckDisplayStateForScreenState;
    }

    public boolean getIndicateUserActivityForHce() {
        return mIndicateUserActivityForHce;
    }
    ...
    public int getUnknownTagPollingDelay() {
        return mUnknownTagPollingDelay;
    }

    public int getUnknownTagPollingDelayMax() {
        return mUnknownTagPollingDelayMax;
    }

    public int getUnknownTagPollingDelayLong() {
        return mUnknownTagPollingDelayLong;
    }
}
