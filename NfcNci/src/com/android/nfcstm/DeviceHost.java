...
public interface DeviceHost {
    ...
    public interface TagEndpoint {
        ...
        void startPresenceChecking(
                int presenceCheckDelay, @Nullable TagDisconnectedCallback callback);
         ...
         * default ndef read before tag dispatch. This system property is valid only in reader mode.
         */
        void findNdef();
    }
     ...
     * {@link #initialize(boolean enableScreenOffSuspend)}, but the firmware may need to be updated
     * after an OTA update.
     *
     ...
     *
     * @return Indicates whether NDEF NFCEE Read or write operation is under process Return "True"
     *     when operation is in progress. else "False"
     */
