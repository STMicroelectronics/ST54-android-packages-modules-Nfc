...
public class NfcShellCommand extends BasicShellCommandHandler {
    ...
    private static final String[] NON_PRIVILEGED_COMMANDS = {
        "help", "disable-nfc", "enable-nfc", "status",
    };
    ...
    public PrintWriter getOutPrintWriter() {
        if (mPrintWriter != null) return mPrintWriter;
        else return super.getOutPrintWriter();
    }
                ...
                case "set-offhost-se":
                    {
                        ...
                        ComponentName componentName =
                                new ComponentName(packageName, serviceClsName);
                ...
                case "register-aid-group":
                    {
                        ...
                        AidGroup aidGroup =
                                new AidGroup(Arrays.asList(aids.split("\\s*,\\s*")), category);
                        mNfcService
                                .mCardEmulationManager
                                .getNfcCardEmulationInterface()
    ...
    private void onHelpPrivileged(PrintWriter pw) {
        ...
        pw.println(
                "  register-aid-group <userId> <package> <service_class> "
