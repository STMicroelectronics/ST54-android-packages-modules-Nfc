...
public class NfcPermissions {
        ...
        try {
            userContext =
                    mContext.createPackageContextAsUser(
                            mContext.getPackageName(), 0, UserHandle.getUserHandleForUid(uid));
    ...
    /**
     * API to validate if a package name belongs to a UID. Throws SecurityException if pkgName does
     * not belongs to a UID
     *
