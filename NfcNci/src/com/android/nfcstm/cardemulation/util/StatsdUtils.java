 ...
 */
package com.android.nfcstm.cardemulation.util;

import static com.android.nfcstm.NfcStatsLog.NFC_POLLING_LOOP_NOTIFICATION_REPORTED__PROPRIETARY_FRAME_TYPE__ECP_V1;
import static com.android.nfcstm.NfcStatsLog.NFC_POLLING_LOOP_NOTIFICATION_REPORTED__PROPRIETARY_FRAME_TYPE__ECP_V2;
import static com.android.nfcstm.NfcStatsLog.NFC_POLLING_LOOP_NOTIFICATION_REPORTED__PROPRIETARY_FRAME_TYPE__PROPRIETARY_FRAME_UNKNOWN;
...
public class StatsdUtils {
    ...
    public static final int CE_UNKNOWN = NfcStatsLog.NFC_CARDEMULATION_OCCURRED__CATEGORY__UNKNOWN;
    ...
    public static final int CE_OFFHOST = NfcStatsLog.NFC_CARDEMULATION_OCCURRED__CATEGORY__OFFHOST;
    ...
    @NonNull private StatsdUtilsContext mStatsdUtilsContext;
    ...
    public void notifyCardEmulationEventServiceBound() {
        ...
        if (mBindingStartTimeMillis > 0) {
            ...
            if (DBG) {
                Log.d(
                        TAG,
                        "notifyCardEmulationEventServiceBound: binding took "
                                + bindingElapsedTimeMillis
                                + " millis");
            }
    ...
    public void logFieldChanged(boolean isOn, int fieldStrength) {
        NfcStatsLog.write(
                NfcStatsLog.NFC_FIELD_CHANGED,
                isOn
                        ? NfcStatsLog.NFC_FIELD_CHANGED__FIELD_STATUS__FIELD_ON
                        : NfcStatsLog.NFC_FIELD_CHANGED__FIELD_STATUS__FIELD_OFF,
                fieldStrength);
     ...
     * change is not known at the time of the change. This value will be cleared after the next call
     * to logObserveModeStateChanged().
     */
    ...
    public void logObserveModeStateChanged(boolean enabled, int triggerSource, int latencyMs) {
        ...
        NfcStatsLog.write(
                NfcStatsLog.NFC_OBSERVE_MODE_STATE_CHANGED,
                enabled
                ...
                overrideTriggerSource != null ? overrideTriggerSource : triggerSource,
                latencyMs);
    ...
    public void logAutoTransactReported(int processor, byte[] data) {
        NfcStatsLog.write(
                NfcStatsLog.NFC_AUTO_TRANSACT_REPORTED, processor, data.length, getFrameType(data));
    }
    ...
    protected void writeToStatsd(PollingFrameLog frameLog) {
        NfcStatsLog.write(
                NfcStatsLog.NFC_POLLING_LOOP_NOTIFICATION_REPORTED,
                frameLog.frameType,
